...
The program BWA uses three main algorithms to perform alignments. SAMtools is a program used for processing the alignments. Download [BWA][1] and [SAMtools][2] before running the following script:
