...
While of course it is absolutely critical to get the upstreams steps right (crap data in, crap results out!), with NGS analysis sometimes we spend so much time there and then when we get to here, where we actually get to interpret the biology, we are exhausted and rush through this part with the bare minimum. So, I'll just get on my soapbox for one minute to say, we, as a community, need to STOP doing this...this is the really fun, cool part that arguably does the most to advance the knowledge in our field!!
