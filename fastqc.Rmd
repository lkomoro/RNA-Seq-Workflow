...
The program FastQC runs several functions that will assess the quality of the inputted raw high throughput sequence data. FastQC can be downloaded [here][1].
