...
The program FastQC runs several tests that will assess the quality of the inputted raw high throughput sequence data. FastQC can be downloaded [here][1].
...
###Evaluating the FastQC reports1
...
[4]:https://github.com/sarinafernandez/RNA-Seq/blob/master/scythe.Rmd